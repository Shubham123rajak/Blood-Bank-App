...
const createInventoryController = async (req, res) => {
    try {
        ...
        if (req.body.inventoryType == 'out') {
            ...
            // calulation Out Blood contatity
...
const getHospitalController = async (req, res) => {
    try {
        ...
        return res.status(500).send({
            success: false,
            memssage: "Error in Hospital reacord",
            error,
        })
    }
}
...
module.exports = {
    createInventoryController, getInventoryController, getDonarsController, getHospitalController,
    getOrgnaisationController, getOrgnaisationForHospitalController, getInventoryHospitalController, getRecentInventoryController
}
